class ProjectsController < ApplicationController
  ...
  before_action :set_tenant, only: [:show, :edit, :update, :desctroy, :new, :create]
  ...
  private
    ...
    def verify_tenant
      unless params[:tenant_id] == Tenant.current_tenant_id.to_s
        redirect_to :root, flash: { error: 'You cannot authorize to access  any orgnization othr than your own'}
      end
    end
end
